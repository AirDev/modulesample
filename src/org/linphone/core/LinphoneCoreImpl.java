...
class LinphoneCoreImpl implements LinphoneCore {
	...
	private native void setMicVol(long nativePtr, float vol);
	public void setMicVol(float vol) {
		Log.e("MicVol:",vol);
		setMicVol(nativePtr, vol);
	}

	private native void setMicLim(long nativePtr, int lim);
	public void setMicLim(int lim) {
		Log.e("MicLim:",lim);
		setMicLim(nativePtr, lim);
	}

	private native void setSpeakerVol(long nativePtr, float vol);
	public void setSpeakerVol(float vol) {
		Log.e("SpeakerVol:",vol);
		setSpeakerVol(nativePtr, vol);
	}

	private native void setSpeakerLim(long nativePtr, int lim);
	public void setSpeakerLim(int lim) {
		Log.e("SpeakerLim:",lim);
		setSpeakerLim(nativePtr, lim);
	}

	private native void setSpeakerMode(long nativePtr, int m);
	public void setSpeakerMode(int m) {
		Log.e("SpeakerMode:",m);
		setSpeakerMode(nativePtr, m);
	}
}
